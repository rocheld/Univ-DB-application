        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setTime(4, Time.valueOf(request.getParameter("START")));
                        pstmt.setTime(5, Time.valueOf(request.getParameter("END")));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "Update public.reviewSchedule set section_id = ? , type = ? , day = ? , start_time = ? , end_time = ? where index = ?");
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM reviewshedule WHERE index = ? ");
                        pstmt.setInt(
