            ...
            <td>
                ...
                String action = request.getParameter("action");
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        "INSERT INTO public.classes(index,class_dept, class_number, class_quarter, class_year) VALUES (?,?, ?, ?, ?)");
                        pstmt.setInt(1, Integer.parseInt(request.getParameter("CLASSID")));
                        pstmt.setString(2,request.getParameter("DEPT"));
                        pstmt.setString(3, request.getParameter("NUM"));
                        pstmt.setString(4, request.getParameter("Q"));
                        pstmt.setString(5, request.getParameter("Y"));
